...
NMilitary = {
	...
	LOOT_DEVASTATION_IMPACT = 50,						-- how much devastation full loot impacts
	...
	COMBAT_DICE_SIDE = 20,							-- How many sides the dice used in combat has
	...
	LEADER_MIN_PIPS = 3,								-- Min general/admiral pips (total)
	...
	INF_LOOT = 0.25,								-- How many ducats/month will a single full strength infantry regiment loot?
...
NAI = {
	...
	EDICT_VALUE_THRESHOLD = 50, -- The higher this value, the less the AI will use Edicts
