...
enum class Idea(val value: String, val prefix: String = "custom_idea", val canBeUsed: (Country) -> Boolean = { true }) {
    ...
    GLOBAL_NAVAL_ENGAGEMENT_MODIFIER("0.2", "custom"),
    ...
    NATIVE_ASSIMILATION("0.5", "custom"),
    NATIVE_UPRISING_CHANCE("-1", "custom"),
    NAVAL_ATTRITION("-0.33", "custom"),
    NAVAL_FORCELIMIT_MODIFIER("0.25"),
    NAVAL_MAINTENANCE_MODIFIER("-0.25"),
    NAVAL_MORALE("0.2"),
    NAVAL_TRADITION_FROM_BATTLE("1", "custom"),
    NAVY_TRADITION("1"),
    ...
    RECOVER_NAVY_MORALE_SPEED("0.25", "custom"),
    ...
    SUNK_SHIP_MORALE_HIT_RECIEVED("-0.2", "custom"),
    TECHNOLOGY_COST("-0.1"),
    TOLERANCE_HEATHEN("2"),
    TOLERANCE_HERETIC("2"),
    TOLERANCE_OWN("2"),
